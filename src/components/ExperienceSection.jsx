...
const ExperienceSection = () => {
    ...
    // Combine experience and projects for the display grid
    const allWork = [
        ...portfolioData.experience.map((exp, index) => ({
            ...
            techStack: portfolioData.skills.slice(0, 3), // Visual filler
            accent: index % 2 === 0 ? "244, 63, 94" : "168, 85, 247",
            gridClass: "md:col-span-2 md:row-span-1",
            bgClass: `bg-[rgba(${index % 2 === 0 ? "244,63,94" : "168,85,247"},0.05)] border-[rgba(${index % 2 === 0 ? "244,63,94" : "168,85,247"},0.5)] border-opacity-50 shadow-lg shadow-[rgba(${index % 2 === 0 ? "244,63,94" : "168,85,247"},0.1)]`
        }))
    ];
    ...
    return (
        <section id="experience" className="w-full max-w-7xl mx-auto px-4 py-16 relative z-20">
            <div className="mb-12">
