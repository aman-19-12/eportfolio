...
const ProjectsSection = () => {
    ...
    const allWork = portfolioData.projects.map((proj, index) => ({
        id: `proj-${index}`,
        title: proj.title,
        category: proj.category,
        shortDesc: proj.description,
        techStack: proj.tags,
        accent: index % 2 === 0 ? "99, 102, 241" : "236, 72, 153",
        gridClass: "md:col-span-4 md:row-span-1",
        bgClass: `bg-[rgba(${index % 2 === 0 ? "99,102,241" : "236,72,153"},0.05)] border-[rgba(${index % 2 === 0 ? "99,102,241" : "236,72,153"},0.5)] border-opacity-50 shadow-lg shadow-[rgba(${index % 2 === 0 ? "99,102,241" : "236,72,153"},0.1)]`
    }));

    const selectedProject = allWork.find(p => p.id === selectedId);

    return (
        <section id="projects" className="w-full max-w-7xl mx-auto px-4 py-16 relative z-20">
            <div className="mb-12">
